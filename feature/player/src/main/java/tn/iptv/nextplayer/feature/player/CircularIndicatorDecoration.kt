...
class CircularIndicatorDecoration(context: Context) : RecyclerView.ItemDecoration() {
    ...
    private val selectedColor: Int = ContextCompat.getColor(context, tn.iptv.nextplayer.core.ui.R.color.selected)
    private val unselectedColor: Int = ContextCompat.getColor(context, tn.iptv.nextplayer.core.ui.R.color.unselected)
